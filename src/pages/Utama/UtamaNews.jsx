...
const newsData = [
  {
    title:
      "Peluncuran IKK bersama YAB Dato Sri Anwar Ibrahim Perdana Menteri Malaysia",
    description:
      "Indeks Keselamatan Kebangsaan (IKK) telah diluncurkan oleh YAB Dato’ Seri Anwar Ibrahim, Perdana Menteri Malaysia pada 30 Julai 2024 bertempat di Putrajaya International Convention Centre (PICC), bersempena perasmian Majlis Bulan Keselamatan Negara Tahun 2024.",
    image:
      "https://ikk.gov.my/wp-content/uploads/2025/07/Screenshot-2025-07-30-013358.png",
    link: "https://www.facebook.com/share/1YLtWAupC9/",
  },
  {
    title: "Townhall IKK 2024",
    description:
      "YM Raja Dato’ Nushirwan Zainal Abidin, Ketua Pengarah Keselamatan Negara (KP MKN) pada Jumaat (27 September 2024) telah turut serta dalam Dialog Awam Indeks Keselamatan Negara (IKK) 2023 di Putrajaya.",
    image:
      "https://ikk.gov.my/wp-content/uploads/2025/07/Screenshot-2025-07-30-003912.png",
  ...
  },
  {
    ...
    image:
      "https://ikk.gov.my/wp-content/uploads/2025/07/Screenshot-2025-07-30-005409.png",
  ...
  },
  {
    ...
    description:
      "Keselamatan negara merupakan aspek utama yang diberikan penekanan serius, bukan sahaja di Malaysia, malahan di seantero dunia. Negara kini perlu sentiasa bersiap siaga bukan sahaja daripada ancaman tradisional seperti peperangan dan pemberontakan; malahan juga ancaman bukan tradisional seperti penyakit berjangkit atau wabak, banjir, perubahan iklim, ancaman siber dan lain-lain.",
    image:
      "https://ikk.gov.my/wp-content/uploads/2025/07/Screenshot-2025-07-30-004541.png",
  ...
  },
  {
    ...
    image:
      "https://ikk.gov.my/wp-content/uploads/2023/11/mkn344_1626067019.jpg",
...
export default function UtamaNews() {
  const settings = {
    dots: true,
    infinite: true,
    speed: 500,
